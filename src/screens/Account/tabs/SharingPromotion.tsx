      ...
      <ScrollView>
        <View style={styles.container}>
          <VStack alignItems="center">
            <ImageBackground
              resizeMode="contain"
              source={sharingQRContainer}
              style={styles.imageBackground}
            >
              <VStack
                pt={width < GLOBAL_SCREEN_SIZE.mobile ? "10px" : "33px"}
                alignItems="center"
                space={width < GLOBAL_SCREEN_SIZE.mobile ? 0 : 3}
              >
                <Text style={styles.headerText}>我的专属邀请码</Text>
                <Image source={QR} style={styles.QRImage} />
                <Text style={styles.redText}>分享好友立赠xx专享会员</Text>
                <Text style={[styles.redText, { marginTop: 35 }]}>
                  邀请码：CDWQMC
                </Text>
              </VStack>
            ...
            <VStack space={5} mt={6} maxW={336}>
              <VStack space={2}>
                ...
                <Text style={styles.whiteTextBold}>
                  ...
                  人，赠送：VIP
                  <Text style={styles.brownText}> 1 </Text>天
                </Text>
                <Text style={styles.whiteTextBold}>
                  推广成功
                  <Text style={styles.brownText}> 3 </Text>
                  人，赠送：VIP
                  <Text style={styles.brownText}> 3 </Text>天
                </Text>
                <Text style={styles.whiteTextBold}>
                  推广成功
                  <Text style={styles.brownText}> 10 </Text>
                  人，赠送：VIP
                  <Text style={styles.brownText}> 10 </Text>天 + 观影券
                  <Text style={styles.brownText}> 5 </Text>元
                </Text>
              </VStack>
              <VStack space={1}>
              ...
              <VStack space={1}>
                ...
                <Text style={styles.grayText}>
                  点击各视频世界分享按钮，保存二维码及推广链接口，立即分享到微博、朋友圈、论坛分类。
                </Text>
              </VStack>
            </VStack>
          </VStack>
